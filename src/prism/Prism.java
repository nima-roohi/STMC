...
public class Prism extends PrismComponent implements PrismSettingsListener {
  ...
  public SimulatorEngine getSimulator() {
    if (theSimulator == null) {
      ...
      if (STMCConfig.enabled)
        switch (STMCConfig.samplingMethod) {
          case INDEPENDENT:
            theSimulator = new SimulatorEngine(this);
            break;
          case ANTITHETIC:
   ...
   * @param file  File to export to
   * @deprecated Load a (built) model and export its transition matrix to a Spy file.
   */
  @Deprecated
   ...
   * @param model The model
   * @param file  File to export to
   * @deprecated Load a (built) model and export the MTBDD for its transition matrix to a Dot file.
   */
  @Deprecated
   ...
   *                   </ul>
   * @param file       File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export its transition matrix to a file
   */
  @Deprecated
   ...
   *                   </ul>
   * @param file       File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export its transition matrix to a file (or to the log)
   */
  @Deprecated
   ...
   *                   </ul>
   * @param file       File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export its state rewards to a file
   */
  @Deprecated
   ...
   *                   </ul>
   * @param file       File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export its transition rewards to a file
   */
  @Deprecated
   ...
   *                   </ul>
   * @param file       File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export its bottom strongly connected components (BSCCs) to a file
   */
  @Deprecated
   ...
   *                       </ul>
   * @param file           File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export the states satisfying labels from it and a properties file to a file
   ...
   *                   </ul>
   * @param file       File to export to (if null, print to the log instead)
   * @deprecated Load a (built) model and export its states to a file
   */
  @Deprecated
   ...
   * @param propertiesFile Parent property file of property (for labels/constants/...)
   * @param expr           The property to check
   * @deprecated Load a (built) model, perform model checking of a property on it and return result.
   */
  @Deprecated
   ...
   * @param propertiesFile Parent property file of property (for labels/constants/...)
   * @param expr           The property to check
   * @deprecated Load a PRISM PTA model, perform model checking of a property on it and return result.
   */
  @Deprecated
  ...
  /**
   * @deprecated Load (built) model and compute steady-state probabilities (DTMCs/CTMCs only).
   * Output probability distribution to log.
   */
  @Deprecated
  ...
  /**
   * @deprecated Load (built) model and compute transient probabilities (DTMCs/CTMCs only).
   * Output probability distribution to log.
   */
  @Deprecated
