...
#run_example "./examples/molecules/nacl.sm -const N1=100    -const N2=100"    "P<0.33[F[0.001,0.001]na>25]"          0.0001 0.0001
#run_example "./examples/molecules/nacl.sm -const N1=1000   -const N2=1000"   "P<0.12[F[0.0001,0.0001]na>250]"       0.0001 0.0001
run_example "./examples/molecules/nacl.sm -const N1=10000  -const N2=10000 " "P<0.06[F[0.00001,0.00002]na>2500]"    0.0001 0.0001
#run_example "./examples/molecules/nacl.sm -const N1=100000 -const N2=100000" "P<0.87[F[0.000001,0.000002]na>24150]" 0.0001 0.0001
