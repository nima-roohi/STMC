...
# ./examples/nand/run.sh > ./examples/nand/res 2>&1
...
#  time timeout 30m $PRISM $1 -pf $2 -exact    | grep -e Result -e Engine -e States -e Transitions -e Error -e "Time for model" ; echo  # Bounded until operator not supported by exact engine.
  ...
  echo
  echo 'strata-size 16'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 6  -alpha $3 -beta $3 -delta $4 -strata_size 2,2,2,2                 | grep -E 'Result:|seconds|Time: average|Samples: average'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 6  -alpha $3 -beta $3 -delta $4 -strata_size 4,4                     | grep -E 'Result:|seconds|Time: average|Samples: average'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 6  -alpha $3 -beta $3 -delta $4 -strata_size 16                      | grep -E 'Result:|seconds|Time: average|Samples: average'

  echo
  echo 'strata-size 256'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 2 -alpha $3 -beta $3 -delta $4 -strata_size 2,2,2,2,2,2,2,2          | grep -E 'Result:|seconds|Time: average|Samples: average'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 2 -alpha $3 -beta $3 -delta $4 -strata_size 4,4,4,4                  | grep -E 'Result:|seconds|Time: average|Samples: average'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 2 -alpha $3 -beta $3 -delta $4 -strata_size 16,16                    | grep -E 'Result:|seconds|Time: average|Samples: average'
  $PRISM $1 -pf $2 -sim -stmc -smp_method stratified -hyp_test_method SSPRT -repeat $repeat -mt 1 -min_iter 2 -alpha $3 -beta $3 -delta $4 -strata_size 256                      | grep -E 'Result:|seconds|Time: average|Samples: average'
...
run_example "./examples/nand/nand.pm -const N=60  -const K=2"  "P>0.7[F<100z>3&z<20]" 0.0001 0.0001
run_example "./examples/nand/nand.pm -const N=90  -const K=5"  "P>0.7[F<100z>3&z<20]" 0.0001 0.0001
run_example "./examples/nand/nand.pm -const N=120 -const K=8"  "P>0.7[F<100z>3&z<20]" 0.0001 0.0001
run_example "./examples/nand/nand.pm -const N=150 -const K=11" "P>0.7[F<100z>3&z<20]" 0.0001 0.0001
