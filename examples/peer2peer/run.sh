...
# ./examples/peer2peer/run.sh > ./examples/peer2peer/res 2>&1
...
run_example "./examples/peer2peer/peer2peer5_5.sm" "P<0.9[F<1\"done\"]" 0.0001 0.0001
run_example "./examples/peer2peer/peer2peer4_8.sm" "P<0.9[F<1\"done\"]" 0.0001 0.0001
run_example "./examples/peer2peer/peer2peer5_7.sm" "P<0.9[F<1\"done\"]" 0.0001 0.0001
run_example "./examples/peer2peer/peer2peer5_8.sm" "P<0.9[F<1\"done\"]" 0.0001 0.0001
